...
async def validate_backward_compatibility() -> None:
    ...
    assert validation_results["is_migrated"], "Configuration should be marked as migrated"
    assert validation_results["has_data_sources"], "Should have data sources"
...
if __name__ == "__main__":
    ...
    async def main() -> int:
        ...
        if success:
            ...
            print("📖 Next steps:")
            print("   1. Review the migration guide: python -m codeweaver.sources.migration_guide")
