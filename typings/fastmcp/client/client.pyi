...
from .transports import ClientTransport, ClientTransportT, FastMCP1Server, FastMCPTransport, MCPConfigTransport, NodeStdioTransport, PythonStdioTransport, SSETransport, StreamableHttpTransport

__all__ = ['Client', 'SessionKwargs', 'RootsHandler', 'RootsList', 'LogHandler', 'MessageHandler', 'SamplingHandler', 'ElicitationHandler', 'ProgressHandler']
logger = ...
...
class Client(Generic[ClientTransportT]):
    ...
    @overload
    def __init__(self: Client[SSETransport | StreamableHttpTransport], transport: AnyUrl, *args, **kwargs) -> None:
        ...
    
    @overload
    def __init__(self: Client[FastMCPTransport], transport: FastMCP | FastMCP1Server, *args, **kwargs) -> None:
        ...
    
    @overload
    def __init__(self: Client[PythonStdioTransport | NodeStdioTransport], transport: Path, *args, **kwargs) -> None:
        ...
    
    @overload
    def __init__(self: Client[MCPConfigTransport], transport: MCPConfig | dict[str, Any], *args, **kwargs) -> None:
        ...
    
    @overload
    def __init__(self: Client[PythonStdioTransport | NodeStdioTransport | SSETransport | StreamableHttpTransport], transport: str, *args, **kwargs) -> None:
        ...
    
    def __init__(self, transport: ClientTransportT | FastMCP | FastMCP1Server | AnyUrl | Path | MCPConfig | dict[str, Any] | str, roots: RootsList | RootsHandler | None = ..., sampling_handler: SamplingHandler | None = ..., elicitation_handler: ElicitationHandler | None = ..., log_handler: LogHandler | None = ..., message_handler: MessageHandlerT | MessageHandler | None = ..., progress_handler: ProgressHandler | None = ..., timeout: datetime.timedelta | float | int | None = ..., init_timeout: datetime.timedelta | float | int | None = ..., client_info: mcp.types.Implementation | None = ..., auth: httpx.Auth | Literal['oauth'] | str | None = ...) -> None:
        ...
    ...
    async def call_tool(self, name: str, arguments: dict[str, Any] | None = ..., timeout: datetime.timedelta | float | int | None = ..., progress_handler: ProgressHandler | None = ..., raise_on_error: bool = ...) -> CallToolResult:
