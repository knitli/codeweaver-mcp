...
class TextCrossEncoder(TextCrossEncoderBase):
    ...
    @classmethod
    def add_custom_model(cls, model: str, sources: ModelSource, model_file: str = ..., description: str = ..., license: str = ..., size_in_gb: float = ..., additional_files: Optional[list[str]] = ...) -> None:
        ...
