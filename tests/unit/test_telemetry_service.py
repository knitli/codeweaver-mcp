...
class TestPostHogTelemetryProvider:
    ...
    @pytest.fixture
    def telemetry_provider(self, default_config):
    ...
    def test_opt_out_no_telemetry_variable(self):
    ...
    def test_config_based_opt_out(self):
        """Test opt-out via configuration."""
        config = TelemetryServiceConfig(enabled=False)
        provider = PostHogTelemetryProvider(config)
        assert not provider._enabled

    def test_runtime_opt_out(self, telemetry_provider):
    ...
    def test_anonymous_mode_toggle(self, telemetry_provider):
    ...
    def test_path_sanitization(self, telemetry_provider):
    ...
    def test_repository_name_sanitization(self, telemetry_provider):
    ...
    def test_query_sanitization(self, telemetry_provider):
    ...
    def test_privacy_info(self, telemetry_provider):
    ...
    @pytest.mark.asyncio
    async def test_event_tracking_disabled(self):
    ...
    @pytest.mark.asyncio
    async def test_health_check(self, telemetry_provider):
    ...
    @pytest.mark.asyncio
    async def test_batch_flushing(self, telemetry_provider):
