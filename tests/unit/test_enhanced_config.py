...
class TestEnhancedCodeWeaverConfig:
    ...
    def test_builtin_profiles_available(self):
        ...
        assert "codeweaver_original" in builtin_profiles
        assert "minimal" in builtin_profiles
        assert "performance" in builtin_profiles

        # Test profile structure
        original_profile = builtin_profiles["codeweaver_original"]
        assert original_profile.name == "codeweaver_original"
    ...
    def test_profile_retrieval(self):
        ...
        profile = config._get_profile("codeweaver_original")
        assert profile is not None
        assert profile.name == "codeweaver_original"
    ...
    def test_original_defaults_setup(self):
        ...
        config = CodeWeaverConfig()
        config.defaults.profile = "codeweaver_original"
