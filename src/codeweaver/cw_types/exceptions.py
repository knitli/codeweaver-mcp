...
class ComponentError(CodeWeaverError):
    ...
    def __init__(
        ...
        Args:
            ...
            original_error: Original exception that caused this error
        """
        super().__init__(message, component=f"{component_type}:{component_name}", original_error=original_error)
...
class EmbeddingProviderError(ProviderError):
    ...
    def __init__(
        ...
        super().__init__(message, "embedding", provider_name, operation, original_error, recovery_suggestions)
...
class SourceProviderError(ProviderError):
    ...
    def __init__(
        ...
        super().__init__(message, "source", provider_name, operation, original_error, recovery_suggestions)
...
class ServiceProviderError(ProviderError):
    ...
    def __init__(
        ...
        super().__init__(message, "service", provider_name, operation, original_error, recovery_suggestions)
...
class BackendError(ProviderError):
    ...
    def __init__(
        ...
        super().__init__(message, "backend", backend_type, operation, original_error, recovery_suggestions)
