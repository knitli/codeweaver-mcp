...
class ProviderCapabilities(BaseModel):
    ...
    # Model configuration
    default_embedding_model: type[ModelCapabilityEnum] | str | None = Field(
        None, description="Default embedding model"
    )
    default_reranking_model: type[ModelCapabilityEnum] | str | None = Field(
        None, description="Default reranking model"
    )
