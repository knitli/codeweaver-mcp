...
class ServiceCapabilities(BaseModel):
    ...
    memory_usage: Annotated[MemoryUsage, Field(description="Expected memory usage category")] = MemoryUsage.MEDIUM
    performance_profile: Annotated[PerformanceProfile, Field(description="Performance characteristics")] = (
