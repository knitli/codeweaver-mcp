...
from pydantic_ai.toolsets import AbstractToolset, ToolsetTool, CombinedToolset, DeferredToolset, FilteredToolset, FunctionToolset, PrefixedToolset, RenamedToolset, PreparedToolset, WrapperToolset,

from codeweaver._settings import Provider as ProviderEnum
...
def infer_provider_class(provider: LiteralString) -> AgentProvider[InterfaceClient]:  # type: ignore
    """Infer the provider from the provider name."""
    provider_class: type[AgentProvider[InterfaceClient]] = get_agent_model_provider(provider) # type: ignore
    return provider_class()


__all__ = ("AgentProvider", "get_agent_model_provider", "infer_provider_class", "ToolsetTool", "AbstractToolset", "CombinedToolset", "DeferredToolset", "FilteredToolset", "FunctionToolset", "PrefixedToolset", "RenamedToolset", "PreparedToolset", "WrapperToolset")
